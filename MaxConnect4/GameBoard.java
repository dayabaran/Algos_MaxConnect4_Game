...
/** Class that simulates the actual gameboard
 * @author Dayabaran
 *
 */
public class GameBoard {
	...
	/** Compute the overall scores for the playernumber
	 * @param playerNumber
	 * @return
	 */
	...
	/** Compute scores for Diagonal-Forward 
	 * @param player
	 * @return
	 */
	...
	/** Compute scores for backward diagonal
	 * @param player
	 * @return
	 */
	...
	/** Checks if the play is actually valid
	 * @param column
	 * @return
	 */
